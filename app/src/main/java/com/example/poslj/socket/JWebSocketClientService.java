package com.example.poslj.socket;
...
import static com.example.poslj.net.Urls.socketUrls;
...
public class JWebSocketClientService extends Service {
    ...
    private Notification getNotification() {
        Notification.Builder builder = new Notification.Builder(this.getApplicationContext()).setSmallIcon(R.mipmap.yft_logo);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            //修改安卓8.1以上系统报错
            ...
            builder.setContentTitle("\"银付通\"正在运行");
        }
    ...
    private void sendNotification(String content) {
        try {
            ...
            Notification.Builder builder = new Notification.Builder(this)
                    ...
                    .setSmallIcon(R.mipmap.yft_logo)
