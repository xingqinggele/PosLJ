...
import com.example.poslj.mefragment.setup.MePayPassOptionsActivity;
...
import com.example.poslj.utils.DecimalDigitsInputFilter;
...
import static com.example.poslj.utils.DESHelperUtil.decrypt;
import static com.example.poslj.utils.DESHelperUtil.encrypt;
import static com.example.poslj.utils.Utility.format2Decimal;
...
public class WithdrawalActivity extends BaseActivity implements View.OnClickListener, TextWatcher {
    ...
    public void Withdrawal(String amount, String type) {
        ...
        HttpRequest.getWithdrawal(params, getToken(),new ResponseCallback() {
            @Override
            public void onSuccess(Object responseObj) {
                //关闭加载框
                loadDialog.dismiss();
