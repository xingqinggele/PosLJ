...
public class MyDialog3 extends CustomDialog implements View.OnClickListener {
    ...
    public MyDialog3(Context context, boolean hasContentView, boolean dimEnabled, float width) {
    ...
    private MyDialog3(Context context, boolean dimEnabled) {
        super(context, dimEnabled);
    }
...
//        setCanceledOnTouchOutside(false);
     ...
     * 设置按钮vaule
     */
    public MyDialog3 setButtonText(String text1, String text2) {
        this.text1 = text1;
        this.text2 = text2;
        return this;
    }

    public MyDialog3 setCanceledOnTouch(boolean cancel) {
     ...
     * @param messageStr
     */
    public MyDialog3 setMessageStr(CharSequence messageStr) {
        this.messageStr = messageStr;
        return this;
    }

    public MyDialog3 setMessageStr(CharSequence messageStr, int gravity) {
        this.messageStr = messageStr;
     ...
     * @param titleStr
     */
    public MyDialog3 setTitleStr(CharSequence titleStr) {
...
//按钮2
     ...
     * @param clickListener
     */
    public MyDialog3 setClickListener(ButtonOnClickListener clickListener) {
     ...
     * @param addView
     */
    public MyDialog3 setNewView(View addView) {
